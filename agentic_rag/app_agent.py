...
from tasks.rewriting_task import create_rephrasing_task
...
# embedder_config = {
#     "provider": "openai",  # Tells CrewAI to treat it as an OpenAI-like endpoint
#     "config": {
#         "api_key": api_key,               
#         "api_base": base_url,  
#         # "api_base": base_url + '/embeddings',  
#         # 'model': 'Meta-Llama-3-8B-Instruct-BPE-fix-GGUF',
...
#     "provider": "openai",
#     "config": {
#         "model": 'text-embedding-ada-002'  # Replace with the correct OpenAI model
#     }
# }



# --- Arqui agentes implementada
...
planning_task = create_planning_task(travel_agent)
...
#     memory_config={
#         "provider": "mem0",
#         "config": {"user_id": chat_id, "api_key": "m0-bnTCjYzJePVtZDrRmibHDe2zvkiByzrMSTde30OM"},
#     },
